# v3 hard evidence gate

Decision: **reject**. Technology: Jev. Models: gemini-3.5-flash-lite, jev-1.13.0.

Improve verification through more explicit support criteria.
...
- Retained 15 of 31 expected facts versus 27 before filtering; source-support state lacked date/entity anchors.
