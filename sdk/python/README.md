# memkit-client
A client library for accessing memkit

## Usage
First, create a client:

```python
from memkit_client import Client
...
```python
from memkit_client import AuthenticatedClient
...
```python
from memkit_client.models import MyDataModel
from memkit_client.api.my_tag import get_my_data_model
from memkit_client.types import Response
...
1. Any endpoint which did not have a tag will be in `memkit_client.api.default`
