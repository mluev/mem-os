...
from ...models.pipeline_stats_out import PipelineStatsOut
...
) -> HTTPValidationError | PipelineStatsOut | None:
    if response.status_code == 200:
        response_200 = PipelineStatsOut.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | PipelineStatsOut]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | PipelineStatsOut
    """
