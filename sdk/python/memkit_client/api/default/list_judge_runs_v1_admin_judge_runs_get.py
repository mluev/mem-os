...
from ...models.judge_runs_out import JudgeRunsOut
...
) -> HTTPValidationError | JudgeRunsOut | None:
    if response.status_code == 200:
        response_200 = JudgeRunsOut.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | JudgeRunsOut]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | JudgeRunsOut
    """
