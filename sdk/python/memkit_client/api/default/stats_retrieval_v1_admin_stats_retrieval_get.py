...
from ...models.retrieval_stats_out import RetrievalStatsOut
...
) -> HTTPValidationError | RetrievalStatsOut | None:
    if response.status_code == 200:
        response_200 = RetrievalStatsOut.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | RetrievalStatsOut]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | RetrievalStatsOut
    """
