...
from ...models.entity_stats_out import EntityStatsOut
...
) -> EntityStatsOut | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = EntityStatsOut.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EntityStatsOut | HTTPValidationError]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        EntityStatsOut | HTTPValidationError
    """
