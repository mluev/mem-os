...
from ...models.people_stats_out import PeopleStatsOut
...
) -> HTTPValidationError | PeopleStatsOut | None:
    if response.status_code == 200:
        response_200 = PeopleStatsOut.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | PeopleStatsOut]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | PeopleStatsOut
    """
