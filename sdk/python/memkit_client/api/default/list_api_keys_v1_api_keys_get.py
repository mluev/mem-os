...
from ...models.api_keys_out import ApiKeysOut
...
) -> ApiKeysOut | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = ApiKeysOut.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiKeysOut | HTTPValidationError]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ApiKeysOut | HTTPValidationError
    """
