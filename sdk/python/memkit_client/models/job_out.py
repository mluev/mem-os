...
if TYPE_CHECKING:
    from ..models.job_out_events_item import JobOutEventsItem
...
class JobOut:
    ...
    Attributes:
        ...
        result (Any):
        status (str):
        events (list[JobOutEventsItem] | Unset):
        user (None | str | Unset):
    """
    ...
    result: Any
    status: str
    events: list[JobOutEventsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _events is not UNSET:
            ...
            for events_item_data in _events:
                events_item = JobOutEventsItem.from_dict(events_item_data)
