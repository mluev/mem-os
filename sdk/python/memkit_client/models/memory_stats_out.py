...
if TYPE_CHECKING:
    from ..models.memory_totals import MemoryTotals
    from ..models.series_point import SeriesPoint


T = TypeVar("T", bound="MemoryStatsOut")


@_attrs_define
class MemoryStatsOut:
    """
    Attributes:
        bucket (Literal['day']):
        from_ (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        totals = MemoryTotals.from_dict(d.pop("totals"))

        memory_stats_out = cls(
            bucket=bucket,
            from_=from_,
            series=series,
            to=to,
        ...
        memory_stats_out.additional_properties = d
        return memory_stats_out
