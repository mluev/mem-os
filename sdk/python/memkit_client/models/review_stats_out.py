...
if TYPE_CHECKING:
    from ..models.review_totals import ReviewTotals
    from ..models.series_point import SeriesPoint


T = TypeVar("T", bound="ReviewStatsOut")


@_attrs_define
class ReviewStatsOut:
    """
    Attributes:
        bucket (Literal['day']):
        from_ (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        totals = ReviewTotals.from_dict(d.pop("totals"))

        review_stats_out = cls(
            bucket=bucket,
            from_=from_,
            series=series,
            to=to,
        ...
        review_stats_out.additional_properties = d
        return review_stats_out
