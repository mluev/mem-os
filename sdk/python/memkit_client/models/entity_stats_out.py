...
if TYPE_CHECKING:
    from ..models.entity_totals import EntityTotals
    from ..models.series_point import SeriesPoint


T = TypeVar("T", bound="EntityStatsOut")


@_attrs_define
class EntityStatsOut:
    """
    Attributes:
        bucket (Literal['day']):
        from_ (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        totals = EntityTotals.from_dict(d.pop("totals"))

        entity_stats_out = cls(
            bucket=bucket,
            from_=from_,
            series=series,
            to=to,
        ...
        entity_stats_out.additional_properties = d
        return entity_stats_out
