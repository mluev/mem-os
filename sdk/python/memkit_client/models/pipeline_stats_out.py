...
if TYPE_CHECKING:
    from ..models.pipeline_totals import PipelineTotals
    from ..models.series_point import SeriesPoint


T = TypeVar("T", bound="PipelineStatsOut")


@_attrs_define
class PipelineStatsOut:
    """
    Attributes:
        bucket (Literal['day']):
        from_ (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        totals = PipelineTotals.from_dict(d.pop("totals"))

        pipeline_stats_out = cls(
            bucket=bucket,
            from_=from_,
            series=series,
            to=to,
        ...
        pipeline_stats_out.additional_properties = d
        return pipeline_stats_out
