...
if TYPE_CHECKING:
    from ..models.people_totals import PeopleTotals
    from ..models.series_point import SeriesPoint


T = TypeVar("T", bound="PeopleStatsOut")


@_attrs_define
class PeopleStatsOut:
    """
    Attributes:
        bucket (Literal['day']):
        from_ (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        totals = PeopleTotals.from_dict(d.pop("totals"))

        people_stats_out = cls(
            bucket=bucket,
            from_=from_,
            series=series,
            to=to,
        ...
        people_stats_out.additional_properties = d
        return people_stats_out
